...
public class DriverController {
	...
	public String listDrivers(@ModelAttribute("fare") String fare, @ModelAttribute("language") String language,
			@ModelAttribute("name") String name, @ModelAttribute("date") String date,
			@ModelAttribute("name") String radioValues, @ModelAttribute("destination") String destination,
			@ModelAttribute("source") String source, @ModelAttribute("drivers") String drivers, Model theModel) {
	...
	public String bookingdetails(@ModelAttribute("fare") String fare, @ModelAttribute("language") String language,
			@ModelAttribute("name") String name, @ModelAttribute("date") String date,
			@ModelAttribute("radioValues") String radioValues, @ModelAttribute("radioValues") String radioValues1,
			@ModelAttribute("destination") String destination, @ModelAttribute("source") String source,
			@ModelAttribute("drivers") String drivers, RedirectAttributes ra, Model theModel) {
