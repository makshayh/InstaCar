...
public class BookingController {
	...
	public String bookingdetails(@ModelAttribute("fare") String fare, @ModelAttribute("language") String language,
			@ModelAttribute("name") String name, @ModelAttribute("radioValues") String radioValues,
			@ModelAttribute("date") String date, @ModelAttribute("destination") String destination,
			@ModelAttribute("source") String source, @ModelAttribute("drivers") String drivers,
			@ModelAttribute("drivers") String pickuptime, RedirectAttributes ra, Model theModel) {
