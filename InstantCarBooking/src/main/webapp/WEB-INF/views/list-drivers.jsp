...
<body>
	...
	<form:form style="" action="bookingdetails"
		modelAttribute="bookingdetails"
		class="align-items-center font-weight-bold" method="GET">
		...
		<input type="hidden" id="destination" name="destination"
			value="${destination}">
		<input type="hidden" id="radioValues" name="radioValues"
			value="${radioValues}">
		...
		<table>
			...
			<c:forEach begin="0" end="${fn:length(fare) - 1}" var="driverdetails"
				varStatus="status">
				<tr>
					...
					<td><input type="radio" value="${drivers[driverdetails].name}"
						onClick="alertRadioValueJS();" id='radioValues' name="radioValues"
						required> <input type="radio"
						value="${fare[driverdetails]}" id='fare' name="fare"><label
						for=radioValues1></label></td>
				</tr>
			</c:forEach>
