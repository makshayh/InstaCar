	...
	<div class="card w-50"
		...
		<div class="card-body"
			...
			<table>
				...
				<tr>
					<h3>
						Source : -<%=request.getParameter("source")%></h3>
				...
				<tr>
					<h3>
						Total Fare : -<%=request.getParameter("fare")%></h3>
				</tr>
			</table>
			<br>
			<br>
		...
		<div class="card-body"
			...
			<h3 style="color: black;">
				<br> For queries call us: 85749215145555 <br> or mail us:<br>demo@example.com
			</h3>
			<br>
			<br>
			<br>
...
<body>
	<script
		src="https://www.paypal.com/sdk/js?client-id=AY8QNv8nXbmffWcaCOzcnrWTTtl48nbGj04VbfxObteCh9A6XmU2gJGI-CWW96wtlGSV26JtI4noWGC3">
